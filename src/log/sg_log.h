...
#define sgLogTrace_Debug(...) \
	sgLog(SG_LOG_TRACE, __FILE__, __LINE__, __VA_ARGS__)
#define sgLogDebug_Debug(...) \
	sgLog(SG_LOG_DEBUG, __FILE__, __LINE__, __VA_ARGS__)
...
#define sgLogError_Debug(...) \
	sgLog(SG_LOG_ERROR, __FILE__, __LINE__, __VA_ARGS__)
#define sgLogFatal_Debug(...) \
	sgLog(SG_LOG_FATAL, __FILE__, __LINE__, __VA_ARGS__)
#else
#define sgLogTrace_Debug(...)
#define sgLogDebug_Debug(...)
